...
import pandas as pd #uvoz biblioteke za rad sa podacima
from transformers import BertTokenizer, BertForSequenceClassification #uvoz biblioteke za obradu teksta

# Učitavanje podataka iz CSV fajla
data = pd.read_csv("tweet_emotions3_bert.csv", header=None, names=["redbr","sentiment","content","polarity"], encoding="ISO-8859-1")
